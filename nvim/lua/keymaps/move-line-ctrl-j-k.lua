-- For some reason the ctrl-jk keys only work when "source $MYVIMRC" command is run
vim.api.nvim_create_autocmd("BufAdd", { command = "source ~/.config/nvim/lua/keymaps/move-line-ctrl-j-k.lua" })
